  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.cardPerfil}>
        ...
        <Text style={styles.email}>teste@allcare.com</Text>
        <Text style={styles.tipo}>Tipo de usuário: Contratante</Text>
      </View>

      <View style={styles.infoBox}>
        <Text style={styles.label}>Nome completo</Text>
        <Text style={styles.valor}>Usuário Teste</Text>

        <Text style={styles.label}>E-mail</Text>
        <Text style={styles.valor}>teste@allcare.com</Text>

        <Text style={styles.label}>Telefone</Text>
        <Text style={styles.valor}>(11) 99999-9999</Text>

        <Text style={styles.label}>Perfil</Text>
        <Text style={styles.valor}>Contratante</Text>
      </View>
